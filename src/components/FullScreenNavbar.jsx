        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-12 px-16 pb-16 flex-1 overflow-hidden ">
              <div className="col-span-4 pr-8 sticky top-0 self-start text-center text-[#ffffff]">
                <svg
                  className="p-2 mb-6"
                ...
                {[
                  ...
                  <p
                    key={item}
                    className="mb-4 cursor-pointer hover:translate-x-1 transition text-2xl font-[LMroman10]"
                  >
                    {item}
                  </p>
                ))}
...
function SectionHeader({ title }) {
  return (
    <div className="mb-4">
      <h2 className="text-4xl font-[LMroman10] text-white font-medium">
        {title}
      </h2>
...
function NavItem({ label, hoverText, delay }) {
  return (
    <motion.div
      ...
      transition={{ delay }}
      className="group flex justify-between items-center py-2 px-6 -mx-6 cursor-pointer rounded-full hover:bg-white/20 transition"
    >
