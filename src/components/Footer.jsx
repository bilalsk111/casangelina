...
const Footer = () => {
  ...
  const xTranslate = useTransform(scrollYProgress, [0.9, 1], ["100%", "0%"]);

  return (
    <div className="relative w-full h-[180vh] bg-[#6E6259]">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full w-full">
          <div className="w-full md:w-[50%] h-full flex flex-col justify-between p-10 md:p-20 text-white">
            <div className="space-y-10">
              <h2 className="w-94"><svg
                  className="p-2 mb-6"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 854.56 135.26"
                >
                  <defs>
                    <g id="caLogo">
              ...
              <div className="text-2xl tracking-[0.2em] leading-loose font-light uppercase mt-25">
                <p>Via Capriglione, 147</p>
                <p>84010 Praiano, Amalfi Coast</p>
                <p>ITALY</p>
                <p className="mt-6 italic">ph +39 089 8131333</p>
              </div>
            </div>
            <div className="flex flex-col gap-6">
              <div className="flex gap-6 opacity-60">
                <Facebook size={18} strokeWidth={1.5} /> <Instagram size={18} strokeWidth={1.5} /> <Twitter size={18} strokeWidth={1.5} />
              </div>
              <p className="text-[9px] tracking-[0.4em] opacity-40 uppercase">© CASA ANGELINA 2026</p>
            </div>
          </div>

          {/* --- RIGHT SIDE: 50VW DASHBOARD (EXACT SCREENSHOT STYLE) --- */}
          <motion.div 
            style={{ x: xTranslate }}
            className="absolute top-0 right-0 w-full md:w-[50vw] h-full bg-[#f4f1ee] z-20 flex flex-col p-10 md:p-16 shadow-[-40px_0_80px_rgba(0,0,0,0.2)]"
          >
            <div className="flex justify-between items-start mb-20">
              <h1 className="text-[10rem] font-extralight text-[#6E6259]/10 leading-none select-none">
                {time.getFullYear()}
              </h1>
              <div className="text-right mt-10">
                <p className="text-[#6E6259]/50 text-xs tracking-widest uppercase mb-1">Tuesday</p>
                <p className="text-[#6E6259] text-4xl font-serif italic">3rd March</p>
              </div>
            </div>
            <div className="flex justify-between items-center border-b border-[#6E6259]/10 pb-6 mb-16 overflow-x-auto no-scrollbar">
              {['Today', 'WED', 'THU', 'FRI', 'SAT', 'SUN', 'MON'].map((day, i) => (
                <div key={day} className="flex flex-col items-center gap-4 group cursor-pointer">
                  <span className={`text-[10px] tracking-[0.3em] uppercase transition-colors ${i === 0 ? 'text-[#6E6259] font-bold' : 'text-[#6E6259]/30'}`}>
                    {day}
                  </span>
                  {i === 0 && <div className="w-1.5 h-1.5 bg-[#6E6259]/20 rounded-full" />}
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-3 gap-10 mb-20">
              <div className="flex flex-col items-center gap-3">
                <div className="h-12 flex items-center"><span className="text-3xl opacity-60">💨</span></div>
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#6E6259]/60">weak</span>
              </div>
              <div className="flex flex-col items-center gap-3">
                <div className="h-12 flex items-center"><span className="text-4xl opacity-60">☁️</span></div>
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#6E6259]/60">partly cloudy</span>
              </div>
              <div className="flex flex-col items-center gap-3">
                <div className="h-12 flex items-center"><span className="text-3xl opacity-60">🌊</span></div>
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#6E6259]/60">smooth</span>
              </div>
            </div>
            <div className="mt-auto flex justify-between items-end border-t border-[#6E6259]/10 pt-10">
               <div className="flex items-baseline gap-1">
                 <span className="text-8xl font-extralight text-[#6E6259]">15</span>
                 <span className="text-3xl font-light text-[#6E6259] align-top">°</span>
               </div>

               <div className="text-right">
                  <h2 className="text-7xl font-extralight text-[#6E6259] tracking-tighter uppercase leading-none">
                    {time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                  </h2>
                  <p className="text-[10px] tracking-[0.4em] text-[#6E6259]/40 uppercase mt-4">Local Time Praiano</p>
               </div>
            </div>
          </motion.div>
        </div>
